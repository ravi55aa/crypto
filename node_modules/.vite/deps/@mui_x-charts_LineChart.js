import {
  ...
  Popper_default,
  useThemeProps
} from "./chunk-GA2ZDNYJ.js";
import {
  Typography_default
} from "./chunk-6V335AND.js";
import {
  require_react_dom
} from "./chunk-NRYBWBEN.js";
import {
  useTheme
} from "./chunk-UPUJ3ZEL.js";
import {
  ownerWindow,
  shouldForwardProp,
  useControlled,
...
} from "./chunk-7OOBHECT.js";
import "./chunk-5HF4O7MJ.js";
import {
  _extends,
...
// node_modules/@mui/x-charts/esm/context/PluginProvider/PluginProvider.js
var React7 = __toESM(require_react());

// node_modules/@mui/x-charts/esm/context/PluginProvider/PluginContext.js
...
// node_modules/@mui/x-charts/esm/context/PluginProvider/mergePlugins.js
...
// node_modules/@mui/x-charts/esm/context/PluginProvider/useColorProcessor.js
...
// node_modules/@mui/x-charts/esm/context/PluginProvider/useSeriesFormatter.js
...
// node_modules/@mui/x-charts/esm/context/PluginProvider/useXExtremumGetter.js
...
// node_modules/@mui/x-charts/esm/context/PluginProvider/useYExtremumGetter.js
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React13.useContext(SeriesContext);
  if (!isInitialized) {
...
function useLineSeries() {
  ...
  return React13.useMemo(() => series.line, [series.line]);
}

// node_modules/@mui/x-charts/esm/context/CartesianProvider/CartesianContext.js
var React14 = __toESM(require_react());
var CartesianContext = React14.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
function CartesianContextProvider(props) {
  ...
  const xValues = React15.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React15.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
var HighlightedContext = React18.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React19.useMemo(() => {
  ...
  const providerValue = React19.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React20.useContext(HighlightedContext);
  if (!isInitialized) {
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React24.createElement(Provider, { value: props }, children);
};
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React26.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function useChartId() {
  ...
  return React27.useMemo(() => chartId, [chartId]);
}
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(React30.Fragment, {
    children: [(0, import_jsx_runtime8.jsx)("clipPath", {
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime8.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(Area, _extends({}, other, areaProps));
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime10.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime10.jsxs)(React32.Fragment, {
        children: [(0, import_jsx_runtime10.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime10.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime11.jsx)("linearGradient", {
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime11.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function useChartGradient() {
  const {
    chartId
  } = React34.useContext(DrawingContext);
  return React34.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime12.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime12.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime12.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime13.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime13.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime14.jsxs)(React36.Fragment, {
    children: [(0, import_jsx_runtime14.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime14.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime14.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime14.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime16.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime16.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var ChartsSurface = React40.forwardRef(function ChartsSurface2(props, ref) {
  ...
  return (0, import_jsx_runtime17.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    ...
    children: [(0, import_jsx_runtime17.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime17.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React41.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React41.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};
...
// node_modules/@mui/x-charts/esm/ChartContainer/useChartContainerProps.js
var _excluded9 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children"];
...
var ChartContainer = React43.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime18.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime18.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime18.jsx)(CartesianContextProvider, _extends({}, cartesianContextProps, {
          children: (0, import_jsx_runtime18.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime18.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime18.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime18.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React44.useRef(false);
...
// node_modules/@mui/x-charts/esm/ResponsiveChartContainer/useResponsiveChartContainerProps.js
var _excluded10 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React45.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime19.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
var _excluded11 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
var _excluded12 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime21.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime21.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
var _excluded13 = ["x", "y", "style", "text", "ownerState"];
...
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded13);
  ...
  return (0, import_jsx_runtime22.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime22.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types14.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types14.default.bool,
  ownerState: import_prop_types14.default.any,
  /**
...
var _excluded14 = ["scale", "tickNumber", "reverse"];
...
function ChartsXAxis(inProps) {
  ...
  const _xAxis = xAxis[inProps.axisId ?? xAxisIds[0]], {
    ...
    tickNumber,
    reverse: reverse2
  } = _xAxis, settings = _objectWithoutPropertiesLoose(_xAxis, _excluded14);
  ...
  return (0, import_jsx_runtime23.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime23.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime23.jsxs)("g", {
        ...
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime23.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
var _excluded15 = ["scale", "tickNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const _yAxis = yAxis[inProps.axisId ?? yAxisIds[0]], {
    scale: yScale,
    tickNumber
  } = _yAxis, settings = _objectWithoutPropertiesLoose(_yAxis, _excluded15);
  const themedProps = useThemeProps({
    props: _extends({}, settings, inProps),
    name: "MuiChartsYAxis"
  });
  ...
  return (0, import_jsx_runtime24.jsxs)(AxisRoot, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React52.Fragment, {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime26.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime26.jsx)("tbody", {
        children: (0, import_jsx_runtime26.jsxs)(ChartsTooltipRow, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types18.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types18.default.shape({
    ...
    type: import_prop_types18.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
   * The series linked to the triggered axis.
   */
  series: import_prop_types18.default.object.isRequired,
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime28.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime28.jsx)("thead", {
        children: (0, import_jsx_runtime28.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime28.jsx)(ChartsTooltipCell, {
            colSpan: 3,
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime28.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime28.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color2 && (0, import_jsx_runtime28.jsx)(ChartsTooltipMark, {
                color: color2,
                className: classes.mark
              })
            }), (0, import_jsx_runtime28.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime28.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types19.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types19.default.shape({
    x: import_prop_types19.default.shape({
      index: import_prop_types19.default.number,
      value: import_prop_types19.default.oneOfType([import_prop_types19.default.instanceOf(Date), import_prop_types19.default.number, import_prop_types19.default.string]).isRequired
    }),
    y: import_prop_types19.default.shape({
      index: import_prop_types19.default.number,
      value: import_prop_types19.default.oneOfType([import_prop_types19.default.instanceOf(Date), import_prop_types19.default.number, import_prop_types19.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types19.default.oneOfType([import_prop_types19.default.instanceOf(Date), import_prop_types19.default.number, import_prop_types19.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime30.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime30.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime30.jsx)(ChartsAxisTooltipContent, {
    ...
    children: (0, import_jsx_runtime31.jsx)(ChartsLegendRoot, {
      ...
      children: itemsWithPosition.map(({
        ...
        children: [(0, import_jsx_runtime31.jsx)("rect", {
          ...
          fill: color2
        }), (0, import_jsx_runtime31.jsx)(ChartsText, {
          style: labelStyle,
          text: label,
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types21.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types21.default.shape({
   ...
   * @default 10
   */
  itemGap: import_prop_types21.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types21.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types21.default.number,
  /**
   ...
   * @default 5
   */
  markGap: import_prop_types21.default.number,
  /**
   * Legend padding (in px).
   * Can either be a single number, or an object with top, left, bottom, right properties.
   * @default 10
   */
  padding: import_prop_types21.default.oneOfType([import_prop_types21.default.number, import_prop_types21.default.shape({
  ...
  series: import_prop_types21.default.object.isRequired,
  seriesToDisplay: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React63.Fragment, {
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types23.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]),
  /**
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types23.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types23.default.number,
  /**
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default false
   */
  hideFirst: import_prop_types24.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types24.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime36.jsxs)(React65.Fragment, {
...
var _excluded20 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime39.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime39.jsx)(Element, _extends({
          id: seriesId,
...
var _excluded23 = ["vertical", "horizontal"];
...
function ChartsGrid(props) {
  ...
  return (0, import_jsx_runtime40.jsxs)(GridRoot, _extends({}, other, {
    ...
    children: [vertical && xTicks.map(({
      formattedValue,
      offset
    }) => (0, import_jsx_runtime40.jsx)(GridLine, {
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      x1: offset,
      x2: offset,
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(React70.Fragment, {});
}
...
init_extends();
var _excluded26 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className"];
...
var LineChart = React74.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime45.jsxs)(ResponsiveChartContainer, _extends({
    ...
    children: [props.onAxisClick && (0, import_jsx_runtime45.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime45.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime45.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime45.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime45.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime45.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime45.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime45.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime45.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime45.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime45.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime45.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime45.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime45.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types31.default.shape({
    x: import_prop_types31.default.oneOf(["band", "line", "none"]),
    y: import_prop_types31.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types31.default.oneOfType([import_prop_types31.default.object, import_prop_types31.default.string]),
   ...
   */
  disableLineItemHighlight: import_prop_types31.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types31.default.shape({
    horizontal: import_prop_types31.default.bool,
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types31.default.oneOfType([import_prop_types31.default.object, import_prop_types31.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types31.default.shape({
   ...
   */
  onAreaClick: import_prop_types31.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   ...
   */
  onLineClick: import_prop_types31.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types31.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types31.default.oneOfType([import_prop_types31.default.object, import_prop_types31.default.string]),
  /**
   ...
   */
  tooltip: import_prop_types31.default.shape({
    axisContent: import_prop_types31.default.elementType,
    classes: import_prop_types31.default.object,
    itemContent: import_prop_types31.default.elementType,
    slotProps: import_prop_types31.default.object,
    slots: import_prop_types31.default.object,
   ...
   * @default null
   */
  topAxis: import_prop_types31.default.oneOfType([import_prop_types31.default.object, import_prop_types31.default.string]),
